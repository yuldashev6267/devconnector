...
export const DELETE_EDUCATION = "DELETE_EDUCTAION";
export const DELETE_EDUCATION_ERROR = "DELETE_EDUCTAION_ERROR";
export const DELETE_EXPIRENCE = "DELETE_EXPIRENCE";
export const DELETE_EXPIRENCE_ERROR = "DELETE_EXPIRENCE_ERROR";
